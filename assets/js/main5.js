...
window.location.href = 'https://wooglobe.com/video-submission/revshare60';
        ...
        $('#video_single_url').on('focusout',function () {
          //  $('#img')[0].reset();
            ...
            if(video_single_url != url){
                    ...
                    if (reg.test(url)){
                        $.ajax({
                            ...
                            success: function(result){
                                ...
                                $("#img").append('<input class="iframe-social" type="hidden" name="img_url[videos][]" value='+src+'>');
                            }
                        });
                    }
                ...
                $(document).on('focusout','.video_single_url',function () {
                        //  $('#img')[0].reset();
                        var url = $(this).val();
                        var $this = $(this);
                        if(video_single_url != url){
                                ...
                                if(url.length == 0){
                                        ...
                                        $this.parent().parent().parent().find('.img').html('');
                                ...
                                if(urlValue[1] == "youtube" || urlValue[0] == "youtube" || urlValue[1] == "youtu" || urlValue[0] == "youtu" || urlValue[0] == "https://youtube" || urlValue[1] == "youtu" || urlValue[0] == "https://youtu"  || urlValue[0] == "http://youtube" || urlValue[1] == "youtu" || urlValue[0] == "http://youtu") {
                                        ...
                                        if (reg.test(url)){
                                                $.ajax({
                                                        ...
                                                        success: function(result){
                                                                var src = result.image;
                                                                console.log($(this).parent().parent().parent().find('.video_title'));
                                                                $this.parent().parent().parent().find('.video_title').val(result.title);
                                                                //$('#message').val(result.description);
                                                                $this.parent().parent().parent().find('.img').show();
                                                                $this.parent().parent().parent().find(".img").html('');
                                                                $this.parent().parent().parent().find(".img").html("<img id='theImg' src="+src+"></>");
                                                                $this.parent().parent().parent().find(".img").append('<input class="iframe-social" type="hidden" name="img_url[videos][]" value='+src+'>');
                                                        }
                                                });
                                        }
                                }else if(urlValue[1] == "instagram" || urlValue[0] == "https://twitter" ){
                                        $.ajax({
                                                ...
                                                success: function (data) {
                                                        ...
                                                        if (data.code == 200) {
                                                                ...
                                                                $this.parent().parent().parent().find('.video_title').val(shorttitle);
                                                                $this.parent().parent().parent().find('.img').show();
                                                                $this.parent().parent().parent().find(".img").html('');
                                                                $this.parent().parent().parent().find(".img").html("<img id='theImg' src="+src+"></>");
                                $this.parent().parent().parent().find(".img").append('<input class="iframe-social" type="hidden" name="img_url[videos][]" value='+src+'>');
                    ...
                    $this.parent().parent().parent().find(".img").append('<input class="iframe-social" type="hidden" name="img_url[videos][]" value="">');
                }
                        }
