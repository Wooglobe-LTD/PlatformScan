...
MINOR: If a minor is depicted in the content, I represent and warrant that I am either a parent or legal guardian of the minor child, and that I have complete authority to grant this Appearance Release on the minor child’s behalf.  I hereby agree that the said minor and I will be bound by all the provisions contained herein, and shall indemnify Company from any claims made by the minor.</textarea>
                                        ...
                                        <div class="form-input w-50">
                                            <label class="ele-lbl">Minor's First Name<span class="mnd-lbl-str">*</span></label>
                                        ...
                                        <!-- last name start  -->
                                        <div class="form-input w-50">
                                            <label class="ele-lbl">Minor's Last Name:<span class="mnd-lbl-str">*</span></label>
                                        ...
                                        <div class="form-input w-50">
                                            <label class="ele-lbl">Guardian's  First Name<span class="mnd-lbl-str">*</span></label>
                                        ...
                                        <!-- last name start  -->
                                        <div class="form-input w-50">
                                            <label class="ele-lbl">Guardian's  Last Name:<span class="mnd-lbl-str">*</span></label>
                                            <input type="text" class="form-control" name="last_name" id="last_name" placeholder=""
                                                   data-parsley-required-message="Last Name field is required."
                                                   pattern="[a-zA-Z0-9\s]+"
                                                   data-parsley-pattern-message="Only alphabets are allowed."
                                    ...
                                    <!-- email start  -->
                                    <div class="form-input">
                                        <label class="ele-lbl">Guardian's Email Address:<span class="mnd-lbl-str">*</span></label>
                        ...
                        <!-- Add Signature start -->
                        <br><br>
                        <label class="ele-lbl">Guardian's signature:<span class="mnd-lbl-str">*</span></label>
                        <div id="signature">
