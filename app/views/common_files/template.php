...
<script src="<?php echo $assets;?>js/main5.js"></script>
<script>
...
<!--<script src="<?php /*echo $assets;*/?>js/jquery-3.2.1.slim.min.js"></script> -->
<script>
(function($) {
    'use strict';
...
<script src="<?php echo $assets;?>js/customs16.js?v=<?=strtotime("now");?>" type="text/javascript" charset="utf-8"></script>
