                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div id="menu" class="main-menu collapse navbar-collapse pull-left">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="menu-item menu-item-has-children <?php if($active == 'cate'){ echo 'active';}?>">
                                    <a href="<?php echo $url;?>categories" class="clickable">Categories</a>
                                    <ul class="sub-menu children">
                                        <?php $parents = parent_categories();
                                         foreach ($parents->result() as $parent){
                                                $childs = child_categories($parent->id);
                                             ?>
                                             <li class="menu-item <?php if($childs->num_rows() > 0){?>menu-item-has-children-right <?php } ?>"><a href="<?php echo $url.'categories/'.$parent->slug;?>"><?php echo $parent->title;?></a>
                                                 <?php if($childs->num_rows() > 0){?>
                                                 <ul class="sub-menu children">
                                                     <?php foreach ($childs->result() as $child){?>
                                                         <li><a href="<?php echo $url.'categories/'.$child->slug;?>"><?php echo $child->title;?></a></li>
                                                     <?php } ?>
