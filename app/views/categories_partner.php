    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12" id="load-more">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-12 margin-top-20">
                            <div>
                            ...
                            foreach ($categories as $category) {
                                ...
                                if ($total > 0) {
                                    ...
                                    <div class="col-md-12 view-more">
                                        ...
                                        <!-- /.section-title -->
                                        <?php if (empty($slug)) { ?>
                                            <a href="<?php echo $url . 'partner/categories/' . $category->slug; ?>"><i
                                            ...
                                            <article class="post type-post">
                                                <div class="entry-thumbnail">
                                                   ...
                                                   /* }*/
                                                    ...
                                                    ?>
                                                    <a href="<?php echo $url ?>partner?video=<?php echo $video->slug; ?>">
                                                        <img src="<?php echo $thumb; ?>" alt="Video Thumbnail 1">
                                    ...
                                    if($slug != '') {
                                        ?>
                                        <h2 class="section-title"><span>Search</span> <?php echo $slug;?></h2>
                                        <div class="not-found">

                                            <span style="margin-bottom: 30px">"No Result Found"</span>
...
<script>
  ...
  var cslug = '<?php echo $slug;?>';
  var ctotal = '<?php echo $total_videos;?>';
