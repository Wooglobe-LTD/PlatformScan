...
<div class="content-wrapper">
    <div class="container">
        ...
        dfsdkgfsdlfk jdlfkjsdlkjflksd jfklj sdklfjksd jlfjsdlflsdkf jlsdjfl
        <div id="accordion">
            <?php foreach ($videos as $video){?>
                <h3><?php echo $video['video_title'];?> 
                    <span style="float: right"><?php $date = $video['created_at'];
            ...
            fdslfjlsdkjfsdjfklsjd lfjdlksd jflkjsdfjsdkljflsdjkflkjsd lkfjsdlkfsd
            f sdhkfgsdjhgfjsd hgfj hgsdjhg fsdjhgfj
        </div>
    </div>
</div>
