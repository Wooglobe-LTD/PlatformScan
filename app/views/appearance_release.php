...
<style>
    ...
    #vviral-video-submit-form .form-group {
        margin: 0;
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
    ...
    #vviral-video-submit-form .form-input.w-50 {
        width: 48%;
    }
    ...
    #vviral-video-submit-form .fileuploader-theme-dragdrop .fileuploader-input {
        border: none;
        border-radius: 6px;
    ...
    #vviral-video-submit-form .fileuploader {
        background: none;
        border: 2px dashed #f5544d;
    }

    #vviral-video-submit-form .social-lnks img {
        width: 100%;
        padding-bottom: 10px;
    }

    #vviral-video-submit-form .social-lnks .iframe-social {
        display: none;
    }

    #vviral-video-submit-form  .fileuploader-input .fileuploader-input-button {
        background: #353641;
    ...
    #vviral-video-submit-form  .fileuploader-input .fileuploader-input-button:hover {
        color: #f5544d;
    }

    #vviral-video-submit-form a.btn.btn--secondary.clear-button {
        background: #353641;
        border: 1px solid #353641;
        border-radius: 0;
        color: #b0bec5;
    ...
    #vviral-video-submit-form a.btn.btn--secondary.clear-button:hover {
        color: #f5544d;
    }

    #vviral-video-submit-form canvas.jSignature {
        background: #eceff1;
    }
            ...
            <div class="process-block01">
                ...
                <?php } ?>
                 <div class="right-panel">
                    <!-- Form start -->
                    <form action="" class="" id="vviral-video-submit-form">
                        <input type="hidden" id="uid" name="uid" value="<?php echo $uid ?>">
                        <!-- Accordion -->
                        <div id="video-submit-frm" class="acordion shadow">
                            <!-- Accordion item 1 -->
                            <div class="card">
                                <div id="PersonalInfo" class="card-header"style="position: relative;">
                                    <h6 data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">APPEARANCE RELEASE<span class="mnd-lbl-str">*</span><div class="tooltip-form-share" style="top:14px; left:210px;padding-left: 6px;"> ?
                                            <span class="tooltiptext">An appearance release is a document required to secure the required rights from video owner for use of the footage in commercial settings. The commercial use of video opens up significantly higher revenue earning opportunities for the video owners.</span>
                                        </div></h6>
                                </div>
...
7. This Appearance Release shall be governed by, and construed in accordance with, the laws of the State of California, applicable to contracts entered into and to be fully performed therein, with any disputes to be submitted to the jurisdiction of the state or federal courts of the State of California, Los Angeles County. I waive the right to revoke this Appearance Release, as well as any other right to injunctive or other equitable relief in connection with this Appearance Release.
                                    ...
                                    <div class="form-input" style="position: relative;">
                                        ...
                                        <textarea type="text" class="form-control vid-sub-txt" name="Help" id="Help" placeholder=""
                                                   style="margin: 0px 0px 20px; height: 165px; width: 100%;line-height: 19px;"
                                                  tabindex="7"><?php /*if(isset($video['question_video_context'])){ echo $video['question_video_context'];}*/?></textarea>
                                        <div class="error" id="Help_err"></div>
                                    </div>
                            ...
                            <a href="#nogo" class="btn btn--secondary clear-button"style="margin-top: 10px;margin-bottom: 10px;">Clear</a>
                                    <div class="pop-checkbx">
                                        <div class="checkbox">
                                            ...
                                            By signing above, I agree that all information submitted through this form is true and accurate and I agree to the Terms of <a href="<?php echo $url;?>appearancerelease" target="_blank">Appearance Release</a><span class="mnd-lbl-str">*</span>
                            ...
                            <!-- submit start -->
                                            <br><br>
                            <input type="submit" name="" class="btn" id="appreance-submit-button" name="appreance-submit-button" value="Submit"/>
                            <!-- submit end -->
                            <?php  ?>
