            ...
            <div class="process-block01">
                ...
                <div class="right-panel">
                    ...
                    <div id="collapseOne" aria-labelledby="PersonalInfo" data-parent="#video-submit-frm" class="collapse in">
                        ...
                        <div class="form-group">
                            ...
                            <!-- address end  -->
                             ...
                             <!-- address 2 start  -->
                            <div class="form-input">
                                <label class="ele-lbl">Address 2 <span style="color: green;font-weight: bold;">(Optional)</span>:</label>
                            ...
                            <div class="pill-container">
                                ...
                                <label style="float: right;width: 45%;font-size: 16px;" class="rev-share-text">Revenue share for the video owner : <?php if(isset($videos['revenue_share'])){ echo $videos['revenue_share'];?>%<?php }?></label>
                    ...
                    <div id="collapseTwo" aria-labelledby="PayPalInfo" data-parent="#video-submit-frm" class="collapse in">
                        ...
                        <!-- Add Video start  -->
                            ...
                            <div id="link_add" class="form-input" style="display: none;position: relative;">
                                ...
                                <input type="text" class="form-control" name="link_name" id="link_name" placeholder="Paste iCloud/Dropbox etc. link here"
                                    data-parsley-required-message="First Name field is required.">
                    ...
                    <label class="ele-lbl">Draw your signature here:<span class="mnd-lbl-str">*</span></label>
                        ...
                        <!-- submit start -->
                        <div class="progress-stat" style="display: none;"><span style="color: green; font-weight: bold;"> Your video uploading is still in progress. Please wait.</span></div>
