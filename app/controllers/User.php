    ...
    public function index()
    {
        ...
        if($this->validation->run() == FALSE){
            ...
            if ($this->sess->userdata('isClientLogin')) {
                ...
                $subject_admin='Unblocking Request';
                $message_admin='There is a request form user '.$to.' for unblocking';
                $result_admin = $this->email('viral@wooglobe.com', $to_name = 'ali', $from, $from_name = '', $subject_admin, $message_admin, $cc = '', $bcc = '', $replyto = '', $replyto_name = '');
                if($result){
                    $response['code'] = 200;
