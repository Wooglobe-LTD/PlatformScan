...
//        $this->load->library('urlmaker');
    ...
    public function email($to,$to_name = '',$from,$from_name = '',$subject,$message,$cc = '',$bcc = '',$replyto = '',$replyto_name = ''){
        ...
        try {
            ...
            $mail->Username = 'admin@wooglobe.com';                // SMTP username
            $mail->Password = 'Gl0be*W00!83';                          // SMTP password
