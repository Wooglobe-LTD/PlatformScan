...
altair_wysiwyg = {
    ...
    _tinymce: function() {
        ...
        if($($tinymce).length) {
            tinymce.init({
                skin_url: assets+'assets/skins/tinymce/material_design',
                ...
                setup:function(ed) {
                    ed.on('change', function(e) {
                        ...
                        $('.wysiwyg_tinymce').val(ed.getContent());
                    });
                }
            });
            ...
            function elFinderBrowser (callback, value, meta) {
                tinymce.activeEditor.windowManager.open({
                    file: assets+'/file_manager/fm_tinymce.html',// use an absolute path!
                    title: 'File Manager',
                    width: 920,
                    height: 440,
                    resizable: 'yes'
