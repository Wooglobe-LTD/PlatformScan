...
altair_crud_table = {
    init: function() {
        ...
        $('#students_crud').jtable({
            ...
            actions: {
                listAction: base_url+'data/crud_table/studentsActions.php?action=list',
                createAction: base_url+'data/crud_table/studentsActions.php?action=create',
                updateAction: base_url+'data/crud_table/studentsActions.php?action=update',
                deleteAction: base_url+'data/crud_table/studentsActions.php?action=delete'
            },
            fields: {
                StudentId: {
                    key: true,
