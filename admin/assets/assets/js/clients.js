...
$(function() {
			...
			success : function(data){
				...
				if(data.code == 204){
					...
					$.each(data.data,function(i,v){
                        ...
                        if($('#'+i+'_e').hasAttr('select') && i === 'gender'){
                            gender.setValue(v);
                        }
    ...
    $(document).on('click','.reset-password',function(){
        ...
        $.ajax({
            type 	: 'POST',
            url  	: base_url+'client_reset_password',
            data 	: {id:id},
            success : function(data){
                data = JSON.parse(data);
                ...
                if(data.code == 204){
                    ...
                    $('#pas-msg').attr('data-message',data.message);
                    $('#pas-msg').click();
