...
<?php foreach($deal_information->result() as $dealInformation){
    ...
    <div class="sub-scrum">
        <div class="scrum_task <?php if($dealInformation->ustatus == 1){ echo 'critical';}else{ echo 'blocker';}?> <?php if($dealInformation->reminder_sent > 0) {echo "reminder_".$dealInformation->reminder_sent;}?>">
