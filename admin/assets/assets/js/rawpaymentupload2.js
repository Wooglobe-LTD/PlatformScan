...
$(function() {
    ...
    window.ParsleyValidator
        ...
        .addMessage('en', 'fileextension', 'File type must be CSV');
    ...
    $(document).on('click','.delete-category',function(){
        ...
        UIkit.modal.confirm('Are you sure to want delete this?', function(){
            $.ajax({
                type 	: 'POST',
                url  	: base_url+'delete_bulk_payment',
                data 	: {id:id},
                success : function(data){
                    data = JSON.parse(data);
...
/*$('#form_validation2').on('submit',function(e){
    var file_value = document.getElementById("file_currency_id").value;
    var Conversion_value = document.getElementById("conversion_currency_id").value;
    if(file_value == Conversion_value){
        alert("Dont do this.");
    }
});*/
