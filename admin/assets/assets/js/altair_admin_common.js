...
// 3. Common functions & variables
    ...
    altair_helpers = {
        ...
        content_preloader_show: function(style,variant,container,width,height) {
            ...
            if(!$body.find('.content-preloader').length) {
                ...
                var preloader_content = (style == 'regular')
                    ? '<img src="'+base_url+'assets/assets/img/spinners/spinner' + image_density + '.gif" alt="" width="32" height="32">'
		...
		custom_preloader_show : function(){
			$('.preloadr-div').show();
		},
		custom_preloader_hide : function(){
			$('.preloadr-div').hide();
		}
    };
