...
$(function() {
    ...
    $('#form_validation2').on('submit',function(e){
        ...
        $.ajax({
            type 	: "POST",
            url  	: base_url+"mobile-app-add_user",
    ...
    $(document).on('click','.edit-comment',function(){
        ...
        $.ajax({
            type 	: 'POST',
            url  	: base_url+'mobile-app-get_comment',
            data 	: {id:id},
            success : function(data){
                data = JSON.parse(data);
    ...
    $('#form_validation3').on('submit',function(e){
        ...
        $.ajax({
            type 	: "POST",
            url  	: base_url+"mobile-app-update",
    ...
    $(document).on('click','.delete-comment',function(){
        ...
        UIkit.modal.confirm('Are you sure to want delete this?', function(){
            $.ajax({
                type 	: 'POST',
                url  	: base_url+'mobile-app-comment-delete',
                data 	: {id:id},
                success : function(data){
                    data = JSON.parse(data);
    ...
    $(document).on('click','.reset-password',function(){
        ...
        UIkit.modal.confirm('Are you sure to want reset password?', function(){
            $.ajax({
                type 	: 'POST',
                url  	: base_url+'mobile-app-user_reset_password',
                data 	: {id:id},
                success : function(data){
                    data = JSON.parse(data);
    ...
    dt_tableExport: function() {
        ...
        if($dt_tableExport.length) {
            table_export = $dt_tableExport.DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": base_url+'mobile-app-get_comments',
