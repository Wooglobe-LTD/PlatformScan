            ...
            <div class="md-card-content">
                ...
                <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th data-name="count">Enqueued Videos</th>
                        <th data-name="cc.feed_delay">Feed Delay</th>
                        <th data-name="cc.feed_time">Feed Time Range (GMT+1)</th>
                        <th data-name="c.url">WEB Feed</th>
                        <th data-name="c.url">MRSS Feed</th>
    ...
    <div class="uk-modal-dialog">
        ...
        <div class="md-card-content large-padding">
            <form id="form_validation2" class="uk-form-stacked">
                    ...
                    <div class="uk-width-medium-1-1">
                        <div class="parsley-row">
                            <select id="type" name="type" required data-parsley-required-message="This field is required." class="md-input">
                                ...
                                <!--<option value="2">Story Content</option>-->
                            </select>
                        </div>
                    </div>
                ...
                <div id="type_partner" class="uk-grid" data-uk-grid-margin style="display: none;">
                    <div class="uk-width-medium-1-1">
                        <div class="parsley-row">
                            <select id="partner_type" name="partner_type" required data-parsley-required-message="This field is required." class="md-input">
                                <option selected value="1">General Category</option>
                                <option value="2">Story Feed</option>
    ...
    <div class="uk-modal-dialog">
        ...
        <div class="md-card-content large-padding">
            <form id="form_validation3" class="uk-form-stacked">
                ...
                <div id="type_partner_e" class="uk-grid" data-uk-grid-margin style="display: none;">
                    <div class="uk-width-medium-1-1">
                        <div class="parsley-row">
                            <select id="partner_type_e" name="partner_type" required data-parsley-required-message="This field is required." class="md-input" select-tt>
                                <option selected value="1">General Category</option>
                                <option value="2">Story Feed</option>
                    ...
                    <div class="uk-width-medium-1-1">
                        <div class="parsley-row">
                            ...
                            <select id="pub_date_e" name="pub_date"  class="md-input" select-m>
                                <option value="">Select MRSS Date</option>
                                <option value="publish_date">Publish Date</option>
                                <option value="created_at">Lead Created</option>
                                <option value="question_when_video_taken">When Was Video Taken</option>
                                <option value="queue_to_mrss">Queue to MRSS</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-3">
                            <input type="checkbox" name="desc_info[]" value="is_title_2" id="cb_is_title_2" />
                            <label>Use Title 2</label>
                    </div>
                </div>
...
<div class="uk-modal" id="enqueued-videos-modal">
    <div class="uk-modal-dialog">
        <div class="uk-modal-header">
            <h3 class="uk-modal-title"> Enqueued Videos </h3>
        </div>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                <div class="dt_colVis_buttons"></div>
                <table id="dt_enqueued_videos" class="uk-table" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th data-name="ev.action">Actions</th>
                            <th data-name="vl.unique_key">WGID</th>
                            <th data-name="mq.publication_date">Publication Date</th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
