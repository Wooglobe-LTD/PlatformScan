...
<?php foreach($progressed->result() as $dis){
    ?>

    <div class="sub-scrum">
        <div class="scrum_task" <?php if($dis->info_count >= 2) { echo 'style="background: #b2f37f;"'; } ?>>
            <div class="uk-grid" data-uk-grid-margin>
                ...
                <div class="uk-width-medium-4-4" >
                    ...
                    <p class="scrum_task_description">Assigned To: <?php echo $dis->name; ?>
                    ...
                    <div class="open-grid drop-down-menu" style="display: none">
                        ...
                        <?php //if($assess['can_view_contract']){?>
                            <div class="sub-grid">
                                <p class="" style="text-align: right; margin-bottom: 0px;"><a href="<?php echo $url.'compilations_urls_info/'.$dis->lead_group_id.'/'.$dis->id;?>" class="md-btn md-btn-primary md-btn-small" data-id="" data-name="" data-email="" title="Add Info"><i class="material-icons">add</i></a></p>
                            </div>
                        <?php //} ?>
                    </div>
                </div>
