    ...
    <div id="top_bar">
        <div class="top_bar_left">
            <ul id="breadcrumbs">
                ...
                <li><span>Video Rights Management</span></li>
            </ul>
        </div>
        ...
        <div id="scrum_board" class="uk-clearfix">
            ...
            <div>
                <div class="scrum_column_heading_wrapper">
                    <div class="scrum_column_heading">Pending(<span id="pending-count"><?php echo $num_pending; ?></span>)</div>
                    <div class="uk-button-dropdown" style="right: 30px;" data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                        ...
                        <div class="uk-dropdown uk-dropdown-small">
                            <ul class="uk-nav uk-nav-dropdown">
                                <li><a href="javascript:void(0);" class="refresh-sort" data-id="scrum_column_pending" data-count="pending-count" data-sort="ASC" data-url="rights-pending-refresh">Sort <i class="material-icons">swap_vert</i></a></li>
                                <li><input id="toogle-asc-4"  type="radio" name="toogle-order-4" class="toogle-order" data-num="4"  data-id="scrum_column_pending" data-sort="ASC"  data-url="rights-pending-refresh">ASC</li>
                                <li><input id="toogle-desc-4" type="radio" name="toogle-order-4" class="toogle-order" data-num="4"  data-id="scrum_column_pending" data-sort="DESC" data-url="rights-pending-refresh"  checked>DESC</li>
                                <li class="uk-nav-divider"></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_pending" data-count="pending-count" data-column="vl.closing_date" data-url="rights-pending-refresh">Closing Time </a></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_pending" data-count="pending-count" data-column="vl.rating_point" data-url="rights-pending-refresh">Rating </a></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_pending" data-count="pending-count" data-column="vl.updated_at" data-url="rights-pending-refresh">Rated Time</a></li>
                                <li><a href="javascript:void(0);" class="last-activity"  data-id="scrum_column_pending" data-column="at.created_at">Last Activity</a></li>
                                <li><a href="javascript:void(0);" class="curr-stage-updated"  data-id="scrum_column_pending" data-column="at.created_at">Stage Updated</a></li>
                                <input type="hidden" class="sort_value" value="ASC">
                                <input type="hidden" class="column_value" value="vl.created_at">
                            </ul>
                        </div>
                    </div>
                    <a class="uk-button-dropdown refresh-column-data"  data-id="scrum_column_pending" data-count="pending-count" data-url="rights-pending-refresh" style="top: 9px;" href="javascript:void(0);">
                        <i class="material-icons">&#xE5D5;</i>
                    </a>

                </div>
                <div class="scrum_column">
                    <div id="scrum_column_pending" class="board-elemets">
            ...
            <div>
                <div class="scrum_column_heading_wrapper" >
                    <div class="scrum_column_heading">Pendding Compilation Leads(<span id="pending-count"><?php echo $num_compilation; ?></span>)</div>
                    <div class="uk-button-dropdown" style="right: 30px;" data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                        <i class="md-icon material-icons" style="margin-right: 4px;">sort</i>
                        <div class="uk-dropdown uk-dropdown-small">
                            <ul class="uk-nav uk-nav-dropdown">
            ...
            <div style="display: none;">
                <div class="scrum_column_heading_wrapper">
                    <div class="scrum_column_heading">Unclaimed(<span id="unclaimed-count"><?php echo $num_unclaimed; ?></span>)</div>
                    <div class="uk-button-dropdown" style="right: 30px;" data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                        <i class="md-icon material-icons" style="margin-right: 4px;">sort</i>
                        <div class="uk-dropdown uk-dropdown-small">
                            <ul class="uk-nav uk-nav-dropdown">
                                <li><a href="javascript:void(0);" class="refresh-sort" data-id="scrum_column_unclaimed" data-count="unclaimed-count" data-sort="ASC" data-url="unclaimed-refresh">Sort <i class="material-icons">swap_vert</i></a></li>
                                <li><input id="toogle-asc-4"  type="radio" name="toogle-order-4" class="toogle-order" data-num="4"  data-id="scrum_column_deals_rated" data-sort="ASC"  data-url="unclaimed-refresh">ASC</li>
                                <li><input id="toogle-desc-4" type="radio" name="toogle-order-4" class="toogle-order" data-num="4"  data-id="scrum_column_deals_rated" data-sort="DESC" data-url="unclaimed-refresh"  checked>DESC</li>
                                <li class="uk-nav-divider"></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_unclaimed" data-count="unclaimed-count" data-column="vl.closing_date" data-url="unclaimed-refresh">Closing Time </a></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_unclaimed" data-count="unclaimed-count" data-column="vl.rating_point" data-url="unclaimed-refresh">Rating </a></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_unclaimed" data-count="unclaimed-count" data-column="vl.updated_at" data-url="unclaimed-refresh">Rated Time</a></li>
                                <li><a href="javascript:void(0);" class="last-activity"  data-id="scrum_column_unclaimed" data-column="at.created_at">Last Activity</a></li>
                                <li><a href="javascript:void(0);" class="curr-stage-updated"  data-id="scrum_column_unclaimed" data-column="at.created_at">Stage Updated</a></li>
                                <input type="hidden" class="sort_value" value="ASC">
                                <input type="hidden" class="column_value" value="vl.created_at">
                            </ul>
                        </div>
                    </div>
                    <a class="uk-button-dropdown refresh-column-data"  data-id="scrum_column_unclaimed" data-count="unclaimed-count" data-url="unclaimed-refresh" style="top: 9px;" href="javascript:void(0);">
                        <i class="material-icons">&#xE5D5;</i>
                    </a>

                </div>
                <div class="scrum_column">
                    <div id="scrum_column_unclaimed" class="board-elemets">
            ...
            <div>
                <div class="scrum_column_heading_wrapper">
                    <div class="scrum_column_heading">Claimed(<span id="claimed-count"><?php echo $num_claimed; ?></span>)</div>
                    <div class="uk-button-dropdown" style="right: 30px;" data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                        <i class="md-icon material-icons" style="margin-right: 4px;">sort</i>
                        <div class="uk-dropdown uk-dropdown-small">
                            <ul class="uk-nav uk-nav-dropdown">
                                <li><a href="javascript:void(0);" class="refresh-sort" data-id="scrum_column_claimed" data-count="claimed-count" data-sort="ASC" data-url="claimed-refresh">Sort <i class="material-icons">swap_vert</i></a></li>
                                <li><input id="toogle-asc-4"  type="radio" name="toogle-order-4" class="toogle-order" data-num="4"  data-id="scrum_column_deals_rated" data-sort="ASC"  data-url="claimed-refresh">ASC</li>
                                <li><input id="toogle-desc-4" type="radio" name="toogle-order-4" class="toogle-order" data-num="4"  data-id="scrum_column_deals_rated" data-sort="DESC" data-url="claimed-refresh"  checked>DESC</li>
                                <li class="uk-nav-divider"></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_claimed" data-count="claimed-count" data-column="vl.closing_date" data-url="claimed-refresh">Closing Time </a></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_claimed" data-count="claimed-count" data-column="vl.rating_point" data-url="claimed-refresh">Rating </a></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_claimed" data-count="claimed-count" data-column="vl.updated_at" data-url="claimed-refresh">Rated Time</a></li>
                                <li><a href="javascript:void(0);" class="last-activity"  data-id="scrum_column_claimed" data-column="at.created_at">Last Activity</a></li>
                                <li><a href="javascript:void(0);" class="curr-stage-updated"  data-id="scrum_column_claimed" data-column="at.created_at">Stage Updated</a></li>
                                <input type="hidden" class="sort_value" value="ASC">
                                <input type="hidden" class="column_value" value="vl.created_at">
                            </ul>
                        </div>
                    </div>
                    <a class="uk-button-dropdown refresh-column-data"  data-id="scrum_column_claimed" data-count="claimed-count" data-url="claimed-refresh" style="top: 9px;" href="javascript:void(0);">
                        <i class="material-icons">&#xE5D5;</i>
                    </a>

                </div>
                <div class="scrum_column">
                    <div id="scrum_column_claimed" class="board-elemets">
            ...
            <div>
                <div class="scrum_column_heading_wrapper" >
                    <div class="scrum_column_heading">Claimed Compilation Leads(<span id="compilation-claimed-count"><?php echo $num_compilation_claimed; ?></span>)</div>
                    <div class="uk-button-dropdown" style="right: 30px;" data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                        <i class="md-icon material-icons" style="margin-right: 4px;">sort</i>
                        <div class="uk-dropdown uk-dropdown-small">
                            <ul class="uk-nav uk-nav-dropdown">
                                <li><a href="javascript:void(0);" class="refresh-sort" data-id="scrum_column_compilation_claimed" data-count="compilation-claimed-count" data-sort="ASC" data-url="rights-compilation-claimed-refresh">Sort <i class="material-icons">swap_vert</i></a></li>
                                <li><input id="toogle-asc-4"  type="radio" name="toogle-order-4" class="toogle-order" data-num="4"  data-id="scrum_column_compilation_claimed" data-sort="ASC"  data-url="rights-compilation-claimed-refresh">ASC</li>
                                <li><input id="toogle-desc-4" type="radio" name="toogle-order-4" class="toogle-order" data-num="4"  data-id="scrum_column_compilation_claimed" data-sort="DESC" data-url="rights-compilation-claimed-refresh"  checked>DESC</li>
                                <!--<li class="uk-nav-divider"></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_compilation" data-count="compilation-count" data-column="vl.closing_date" data-url="rights-compilation-refresh">Closing Time </a></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_compilation" data-count="compilation-count" data-column="vl.rating_point" data-url="rights-compilation-refresh">Rating </a></li>
                                <li><a href="javascript:void(0);" class="refresh-column" data-id="scrum_column_compilation" data-count="compilation-count" data-column="vl.updated_at" data-url="rights-compilation-refresh">Rated Time</a></li>
                    ...
                    <a class="uk-button-dropdown refresh-column-data"  data-id="scrum_column_compilation_claimed" data-count="compilation-claimed-count" data-url="rights-compilation-claimed-refresh" style="top: 9px;" href="javascript:void(0);">
                        <i class="material-icons">&#xE5D5;</i>
                    </a>
