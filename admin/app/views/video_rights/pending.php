...
<?php foreach($pending->result() as $dis){
    ...
    <div class="sub-scrum">
        <div class="scrum_task <?php if($dis->ustatus == 1){ echo 'critical';}else{ echo 'blocker';}?>" <?php if($dis->compilation == 1) { echo 'style="background: #C8C8C8;"'; } ?>>
            <div class="uk-grid" data-uk-grid-margin>

                <div class="uk-width-medium-4-4" >
                    <h3 class="scrum_task_title">

                        <a href="<?php echo $baseurl.'video-rights-detail/'.$dis->id ?>" class="deal_detail" data-id="<?php echo $dis->id;?>"><?php echo $dis->video_title;?></a>
                    </h3>
...
-->                    <div class="scrum_task_rating">
                    ...
                    <p class="scrum_task_description">YT ID: <?php echo $dis->youtube_id ;?></p>
                    <p class="scrum_task_description">WG ID: <?php echo $dis->unique_key;?></p>
                    <p class="scrum_task_description">Last Activity: <?php echo getTimeInterval($last_activity);?>
                    <p class="scrum_task_description">Publish Date: <?php  echo $dis->publish_datetime; ?>
                    <p class="scrum_task_description">Submitted date: <?php echo $dis->publish_date; ?>
                        <?php if($dis->compilation == 1) {  ?>
                    <p class="scrum_task_description">
                        <a href="<?php echo base_url('video-compilation-detail/'.$dis->ytc_id);?>" target="_blank">Compilation Video</a>
                    </p>
                    <?php } ?>
