...
<?php foreach($compilation_claimed->result() as $dis){
    ?>
...
-->
                    ...
                    <div class="open-grid drop-down-menu" style="display: none">
                        ...
                        <?php //if($assess['can_view_contract']){?>
                            <!--<div class="sub-grid">
                                <p class="" style="text-align: right; margin-bottom: 0px;"><a target="_blank" href="<?php /*echo $url.'compilations_urls_info/'.$dis->lead_group_id.'/'.$dis->id;*/?>" class="md-btn md-btn-primary md-btn-small" data-id="" data-name="" data-email="" title="Update Info"><i class="material-icons">&#xE254;</i></a></p>
                            </div>-->
                        <?php //} ?>
                    </div>
                </div>
