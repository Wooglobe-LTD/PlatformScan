    ...
    <div class="mWrap">
        <div class="mCover">
            ...
            <div class="input-mail-box">
                <div class="input-mail-row"><label>To:</label><input type="email" id='to' class="emailinput ei" value='<?php echo $to;?>' />
                ...
                <div class="input-mail-subject"><input type="text" class="" id="subject" placeholder="Subject" value="Re : <?php echo $email['subject'];?>" /></div>
            </div>
            ...
            <script language="javascript" type="text/javascript">
                ...
                <div id="new_msg" style="min-height: 100px; margin-top: 10px; margin-bottom: 10px;" class="new_msg">
                    <p></p><br><br>
                    <div id="info" style="margin-bottom: 30px; margin-top: 15px;">
