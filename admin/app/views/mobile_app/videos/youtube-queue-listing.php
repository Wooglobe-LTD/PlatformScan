    ...
    <div id="page_content_inner">
        ...
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                ...
                <table id="dt_tableExport_youtube_video_queue" class="uk-table" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th data-name="v.action">Actions</th>
                        <th data-name="v.title">Video Title</th>
                        <th data-name="v.url">Video URL</th>                      
                        <th data-name="v.youtube_channel_id">Youtube Channel ID</th>
                     
                        <th data-name="v.youtube_channel_title">Youtube Channel Title</th>
