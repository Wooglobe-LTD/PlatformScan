...
<div id="page_content">
    <div id="top_bar">
        <ul id="breadcrumbs">
            ...
            <li><span>Import Videos</span></li>
        </ul>
    </div>
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-content large-padding">
                <form id="import_videos" class="uk-form-stacked">
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-1-1">
                            <input type="file" name="csv" class="dropify_my" id="dropify_my" data-allowed-file-extensions="csv CSV" data-show-errors="true"/>
                            <div class="error"></div>
                        </div>
                    </div>
