...
<div id="page_content">
    <div id="top_bar">
        <ul id="breadcrumbs">
            ...
            <li><span>Mobile Assignment Management</span></li>
        </ul>
    </div>
            ...
            <div class="md-card-content">
                ...
                <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <?php } ?>
                        <th data-name="user_id">User</th>
                        <th data-name="event_id">Event</th>
                        <th data-name="video">Video Url</th>
                        <th data-name="is_approved">Approved</th>
...
<div class="uk-modal" id="edit_model">
    <div class="uk-modal-dialog">
        <div class="uk-modal-header">
            <h3 class="uk-modal-title">Edit Assignment </h3>
        </div>
        <div class="md-card-content large-padding">
            <form id="assignment_form_validation3" class="uk-form-stacked">
               ...
               <!-- <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-1">
                        <div class="parsley-row">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9\s]+"
                                   data-parsley-pattern-message="Only alphabet and number are allowed."
                                   data-parsley-required-message="This field is required." name="user_id" id="user_id_e"
                                   required class="md-input" readonly/>
                            <div class="error"></div>
                        </div>
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-1">
                        <div class="parsley-row">
                            <label for="title">Event<span class="req">*</span></label>
                            <input type="text" pattern="[a-zA-Z0-9\s]+"
                                   data-parsley-pattern-message="Only alphabet and number are allowed."
                                   data-parsley-required-message="This field is required." name="event_id" id="event_id_e"
                                   required class="md-input" readonly/>
                            <div class="error"></div>
                        </div>
                    </div>
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-1">
                        <div class="parsley-row">
                            ...
                            <select id="is_approved_e" name="is_approved" required
                                    data-parsley-required-message="This field is required." class="md-input">
