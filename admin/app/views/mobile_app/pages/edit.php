            ...
            <div class="md-card-content large-padding">
                <form id="form_validation3" class="uk-form-stacked">
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            <div class="parsley-row">
                                <label for="body" class="uk-form-label">Page Body<span class="req">*</span></label>
                                <textarea id="body" name="body" cols="30" rows="20" class="wysiwyg_tinymce"><?php echo $data->body;?></textarea>
                                <div class="error"></div>
                            </div>
                        </div>
