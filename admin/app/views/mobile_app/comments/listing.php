...
<div id="page_content">
    <div id="top_bar">
        <ul id="breadcrumbs">
            ...
            <li><span>Mobile App Comments Management</li>
        </ul>
    </div>
            ...
            <div class="md-card-content">
                ...
                <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th data-name="title">Video_title</th>
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-2">
                        <div class="parsley-row">
                            ...
                            <input type="text" data-parsley-required-message="This field is required." name="comment" id="comment_e" required class="md-input" />
                            <div class="error"></div>
                        </div>
                    </div>
