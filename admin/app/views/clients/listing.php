...
<div id="page_content">
    <div id="top_bar">
        <ul id="breadcrumbs">
            ...
            <li><span>Clients Management</span></li>
        </ul>
    </div>
...
<?php } ?>
					...
					<div class="uk-grid" data-uk-grid-margin>
						...
						<div class="uk-width-medium-1-2">
							<div class="parsley-row">
                                ...
                                <input type="text" data-parsley-required-message="This field is required." name="mobile" id="mobile"  class="md-input" />
                                <div class="error"></div>
							</div>
						</div>
                        <div class="uk-width-medium-1-2">
							<div class="parsley-row">
                                ...
                                <input type="text" data-parsley-required-message="This field is required." name="address" id="address"   class="md-input" />
                                <div class="error"></div>
							</div>
						</div>
                    </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-2">
                            <div class="parsley-row">
                                ...
                                <select id="gender" name="gender" data-parsley-required-message="This field is required." class="md-input">
    ...
    <div class="uk-modal" id="edit_model">
		<div class="uk-modal-dialog">
			<div class="uk-modal-header">
				<h3 class="uk-modal-title">Edit Client </h3>
			</div>
			<div class="md-card-content large-padding">
				<form id="form_validation3" class="uk-form-stacked">
					...
					<div class="uk-grid" data-uk-grid-margin>
						...
						<div class="uk-width-medium-1-2">
							<div class="parsley-row">
								<label for="mobile_e">Mobile</label>
                                <input type="text" data-parsley-required-message="This field is required." name="mobile" id="mobile_e"  class="md-input" />
                                <div class="error"></div>
							</div>
						</div>
                        <div class="uk-width-medium-1-2">
							<div class="parsley-row">
                                ...
                                <input type="text" data-parsley-required-message="This field is required." name="address" id="address_e"   class="md-input" />
                                <div class="error"></div>
							</div>
						</div>
                    </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-2">
                            <div class="parsley-row">
                                ...
                                <select id="gender_e" name="gender" data-parsley-required-message="This field is required." class="md-input" select >
                                    <option value="">Gender</option>
                                    <option value="Male">Male</option>
                                    <option value="Female">Female</option>
                                </select>
