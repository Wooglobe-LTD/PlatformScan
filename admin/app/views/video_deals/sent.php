 ...
 * Time: 12:14 PM
 */?>
<?php foreach($contractSent->result() as $sent){
    ...
    <div class="sub-scrum">
        <div class="scrum_task critical <?php if($sent->reminder_sent > 0) {echo "reminder_".$sent->reminder_sent;}?>">
            <h3 class="scrum_task_title"><a href="javascript:void(0);" class="deal_detail" data-id="<?php echo $sent->id;?>"><?php echo $sent->video_title;?></a></h3>
            <p class="scrum_task_title"><a href="javascript:void(0);" class="deal_detail" data-id="<?php echo $sent->id;?>"><?php echo $sent->first_name.' '.$sent->last_name;?></a></p>
