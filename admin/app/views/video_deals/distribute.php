...
<?php foreach($distribute->result() as $dis){
    ...
    <div class="sub-scrum">
        <div class="scrum_task <?php if($dis->ustatus == 1){ echo 'critical';}else{ echo 'blocker';}?>">
            <div class="uk-grid" data-uk-grid-margin>

                <div class="uk-width-medium-4-4" >
                    <h3 class="scrum_task_title">

                        <a href="javascript:void(0);" class="deal_detail" data-id="<?php echo $dis->id;?>"><?php echo $dis->video_title;?></a>
                    </h3>

                    <p class="scrum_task_title"><a href="javascript:void(0);" class="deal_detail" data-id="<?php echo $dis->id;?>"><?php echo $dis->first_name.' '.$dis->last_name;?></a></p>
                    ...
                    <div class="open-grid drop-down-menu" style="display: none">
						...
						<?php if($assess['verify'] ){ ?>
							...
							?>
							<div class="sub-grid" >
								<p class="scrum_task_info"><a href="<?php echo $yt_anchor_link;?>" style="width:100%; " class="md-btn md-btn-primary md-btn-small md-btn-wave-light waves-effect waves-button waves-light <?php echo $color_code_yt?>" data-id="<?php echo $dis->video_id;?>" data-url="<?php echo $data_url_yt;?>"><i class="uk-icon-youtube-play uk-icon-medium"></i></a></p>
							</div>
							<div class="sub-grid">
