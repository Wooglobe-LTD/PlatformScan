...
<?php foreach($contract_signed->result() as $sign){
    ...
    <div class="sub-scrum">
        <div class="scrum_task critical" <?php if($sign->simple_video == 1) { echo 'style="background: #C8C8C8;"'; } ?>>
            <h3 class="scrum_task_title"><a href="<?php echo $baseurl.'deal-detail/'.$sign->id ?>" class="deal_detail" data-id="<?php echo $sign->id;?>"><?php echo $sign->video_title;?></a></h3>
            <p class="scrum_task_title"><a href="<?php echo $baseurl.'deal-detail/'.$sign->id ?>" class="deal_detail" data-id="<?php echo $sign->id;?>"><?php echo $sign->first_name.' '.$sign->last_name;?></a></p>
