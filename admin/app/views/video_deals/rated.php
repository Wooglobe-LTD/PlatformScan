<?php foreach($dealsRated->result() as $rated){
    ...
    <div class="sub-scrum">
        <div class="scrum_task critical <?php if($rated->reminder_sent > 0) {echo "reminder_".$rated->reminder_sent;}?>">
            <h3 class="scrum_task_title"><a href="javascript:void(0);" class="deal_detail" data-id="<?php echo $rated->id;?>"><?php echo $rated->video_title;?></a></h3>
            <p class="scrum_task_title"><a href="javascript:void(0);" class="deal_detail" data-id="<?php echo $rated->id;?>"><?php echo $rated->first_name.' '.$rated->last_name;?></a></p>
