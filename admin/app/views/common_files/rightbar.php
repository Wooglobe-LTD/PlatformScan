                        ...
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content">
                                ...
                                <div class="timeline_content_addon">
                                    <img src="<?php echo $asset;?>assets/img/gallery/Image16.jpg" alt=""/>
                                </div>
                            </div>
                        </div>
                        <div class="timeline_item">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        <li>
                                            <div class="md-list-addon-element">
                                                <img class="md-user-image md-list-addon-avatar" src="<?php echo $asset;?>assets/img/avatars/avatar_02_tn.png" alt=""/>
                                            </div>
                ...
                <li>
                    <ul class="md-list md-list-addon chat_users">
                        ...
                        <li>
                            <div class="md-list-addon-element">
                                <span class="element-status element-status-success"></span>
                                <img class="md-user-image md-list-addon-avatar" src="<?php echo $asset;?>assets/img/avatars/avatar_09_tn.png" alt=""/>
                            </div>
                            <div class="md-list-content">
                                <div class="md-list-action-placeholder"></div>
                        ...
                        <li>
                            <div class="md-list-addon-element">
                                ...
                                <img class="md-user-image md-list-addon-avatar" src="<?php echo $asset;?>assets/img/avatars/avatar_04_tn.png" alt=""/>
                            </div>
                            <div class="md-list-content">
                                <div class="md-list-action-placeholder"></div>
                        ...
                        <li>
                            <div class="md-list-addon-element">
                                ...
                                <img class="md-user-image md-list-addon-avatar" src="<?php echo $asset;?>assets/img/avatars/avatar_07_tn.png" alt=""/>
                            </div>
                            <div class="md-list-content">
                                <div class="md-list-action-placeholder"></div>
                        ...
                        <div class="chat_box chat_box_colors_a">
                            <div class="chat_message_wrapper">
                                <div class="chat_user_avatar">
                                    <img class="md-user-image" src="<?php echo $asset;?>assets/img/avatars/avatar_11_tn.png" alt=""/>
                                </div>
                            ...
                            <div class="chat_message_wrapper chat_message_right">
                                <div class="chat_user_avatar">
                                    <img class="md-user-image" src="<?php echo $asset;?>assets/img/avatars/avatar_03_tn.png" alt=""/>
                                </div>
                                <ul class="chat_message">
                                    <li>
                                        <p>
