...
class Imap
{
	 ...
	 * @var string
	 */
	protected $folder = '[Gmail]/All Mail';
	 ...
	 * @return array
	 */
	public function paginate(array $uids, $page = 1, $per_page = 10)
	{
    ...
    /**
     * [search_to_from Email to and From]
     *
     * @param string $str
     *
     * @return Imap
     */
    public function search_to_from($email)
    {

        $this->search_criteria .= ' TO "' . $email . '"';
        return $this;
    }
	...
	public function getAllMessages($folder ='[Gmail]/All Mail'){
        //$result = imap_fetch_overview($this->stream,"1:{$this->count_messages($folder)}",0);
        $result = imap_fetch_overview($this->stream,"1:1000",0);
