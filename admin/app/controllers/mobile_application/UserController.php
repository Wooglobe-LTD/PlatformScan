...
class UserController extends APP_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->data['active'] = 'Mobile App Users';
        $css = array(
        ...
        $this->load->model('MobileAppUser','user');
    ...
    public function index()
    {
        ...
        $this->data['content'] = $this->load->view('mobile_app/users/listing',$this->data,true);
