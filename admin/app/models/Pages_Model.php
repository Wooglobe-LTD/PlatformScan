...
class Pages_Model extends APP_Model {
	...
	public function getAllPages($fields = '*',$search = '',$start = 0,$limit = 0,$orderby = 'ctp.id DESC',$colums = '')
	{
		if(is_array($fields)){
